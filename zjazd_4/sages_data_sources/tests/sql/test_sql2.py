...
class TestSql:
    ...
    def test_load_passengers_without_tickets(self, load_titanic_data):
        ...
        df = run_query("""select Name from passengers
                left outer join tickets on passengers.PassengerId = tickets.PassengerId
                where tickets.PassengerId is null
                """)
    ...
    def test_load_passengers_and_their_cabin_numbers_keep_passengers_without_tickets(self, load_titanic_data):
        ...
        """
        df = run_query("""select p.Name, t.Cabin from passengers p
        left outer join tickets t on p.PassengerId = t.PassengerId
        """)
